<template>
  <div class="login">
    ...
    <y-drawer title="忘记密码" :visible.sync="visible" :before-close="handleClose" @cancel="handleCancel" @confirm="handleConfirm">
      <y-form ref="forgetForm" v-model="forgetPasswordForm" :config="forgetPasswordConfig" label-width="100px"></y-form>
    </y-drawer>
  </div>
</template>
          ...
          fieldType: {
            render: (h) => {
              return <div style='display: flex; justify-content: space-between'>
                <el-input maxLength={6} type='password' style='width: 62%' v-model={this.forgetPasswordForm.verificationCode} placeholder='请输入验证码'>
      ...
      const code = {
        code: {
          ...
          fieldType: {
            render: () => {
              return <div style='display: flex; justify-content: space-between'>
                <el-input maxLength={6} type='password' style='width: 60%' v-model={this.form.code} placeholder='请输入验证码'>
                  <i slot='prefix' class='el-icon-lock' ></i>
                </el-input>
...
.login-content{
  ...
  align-items: center;
  background-image: url('../../assets/leftside.png');
