/* 此配置为系统默认设置，需修改的设置项，在src/config/customer/setting.config.js */
module.exports = {
  ...
  systemName: 'Vue Saas Admin', // 系统名称
  copyright: '2022 集鲜 前端团队出品', // copyright
  recordNumber: '蜀ICP备20017590号-1', // 备案号
